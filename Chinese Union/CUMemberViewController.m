...
//                            [MBProgressHUD hideAllHUDsForView:self.navigationController.view animated:YES];
                            ...
                            [self showAlertTitle:NSLocalizedString(@"Error", @"")
                                             msg:NSLocalizedString(@"The Member ID has already been activated!", @"")];
                        }
                    }];
...
//                    [MBProgressHUD hideAllHUDsForView:self.navigationController.view animated:YES];
                    ...
                    [self showAlertTitle:NSLocalizedString(@"Congratulations!", @"")
                                     msg:NSLocalizedString(@"You have successfully activated your CU membership, thank you!", @"")];
                }
                ...
                [self showAlertTitle:NSLocalizedString(@"Error", @"")
                                 msg:NSLocalizedString(@"Invalid Member ID Entered! No matching found!", @"")];
            }
        }
        else {
            NSLog(@"Error: %@ %@",error,[error userInfo]);
            [self showAlertTitle:NSLocalizedString(@"Error", @"")
                             msg:NSLocalizedString([error userInfo][@"error"], @"")];
        }
        [self updateMemberView];
    }];
}
