...
- (void)cell:(PAPBaseTextCell *)cellView didTapUserButton:(User *)user {
...
- (void)settingsButtonAction:(id)sender {
    ...
    UIActionSheet *actionSheet = [[UIActionSheet alloc] initWithTitle:nil delegate:settingsActionSheetDelegate cancelButtonTitle:@"Cancel" destructiveButtonTitle:nil otherButtonTitles:@"My Profile", @"Find Friends", nil];
